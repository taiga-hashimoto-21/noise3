...
# 下段：ノイズ付き
ax2.plot(time_points, noisy_A3, linewidth=0.7, color='red', alpha=0.8)
ax2.set_xlabel('Time (sampling points)', fontsize=14)
ax2.set_ylabel('Voltage', fontsize=14)
ax2.set_title('Noisy Signal (Brown Noise 1/f²)', fontsize=12, fontweight='bold')
ax2.grid(True, alpha=0.3)
ax2.set_ylim(-9e-13, 7e-13)
ax2.ticklabel_format(style='scientific', axis='y', scilimits=(0,0), useOffset=False)

plt.tight_layout()
plt.savefig('1_sample_A3_brown_noise_1_over_f2.png', dpi=150, bbox_inches='tight')
plt.close()
print("  Saved: 1_sample_A3_brown_noise_1_over_f2.png")
